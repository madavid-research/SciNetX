...
![SciNetX logo](img/SciNetX_logo_wordmark_below_square_1024.png)
...
- **Program and initiative reporting**: Work from a results package that supports internal reporting, evaluation, and repeatable review over time.
...
1. Run SciNetX on supported inputs.
...
- What you get with SciNetX: [what_you_get.md](what_you_get.md)
...
- Downloadable binaries or containers
- Credentials or internal distribution details
