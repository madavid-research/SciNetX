...
This page defines distribution terms used in this public landing repository without including any URLs.

## Portal
An institution-managed distribution site used to provide licensed users with downloads and release notes.

## Registry
A container image registry used to distribute Docker images (if Docker artifacts are provided).

## Image tag
A human-readable Docker image reference (for example, `org/name:version`). Tags can move over time.
