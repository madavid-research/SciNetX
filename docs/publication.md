...
SciNetX `v1.0.0` is described in a publication in Bone Reports. This GitHub repository is the stable public record for the software and publication materials, while the current website is [scinetx.com](https://scinetx.com).
...
## How to cite SciNetX
- Cite the publication above as the primary paper reference
...
- What SciNetX includes: [what_you_get.md](what_you_get.md)
...
## Media kit
- Icon (PNG): [docs/img/SciNetX_logo_icon_only_square_1024.png](img/SciNetX_logo_icon_only_square_1024.png)
- Wordmark (PNG): [docs/img/SciNetX_logo_wordmark_below_square_1024.png](img/SciNetX_logo_wordmark_below_square_1024.png)
- Icon (SVG): [docs/img/SciNetX_logo_icon_only_square.svg](img/SciNetX_logo_icon_only_square.svg)
- Wordmark (SVG): [docs/img/SciNetX_logo_wordmark_below_square.svg](img/SciNetX_logo_wordmark_below_square.svg)

Use only approved public materials for papers, talks, websites, and press coverage.
