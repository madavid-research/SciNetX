...
## `output/` workspace
A filesystem folder produced by the SciNetX pipeline run. The UI reads this folder to render dashboards, tables, and network views.

## Data root
The folder selected in the UI that points at the `output/` workspace root.
