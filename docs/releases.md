...
- Docker image reference and a pinned digest
- Compliance bundle (third-party licenses/notices + inventories)
- Source snapshot zip (provided on request or separately gated)

## Public overview
Public visitors can review the SciNetX workflow, delivery model, and plain-language product overview before requesting access:

- [what_you_get.md](what_you_get.md)
